...
export function CoursePricingFinal({
  ...
  return (
    <section className="border-b border-white/[0.08] bg-lime text-night">
      <div className="mx-auto max-w-[1100px] px-6 py-24 lg:py-28">
        <div className="mx-auto max-w-[640px] text-center">
          ...
          <h2 className="mt-4 text-[36px] font-extrabold leading-tight tracking-[-0.01em] text-night lg:text-[48px]">
        ...
        <div className="mx-auto mt-14 max-w-[520px] overflow-hidden rounded-3xl border border-white/[0.08]/10 bg-night text-chalk shadow-2xl shadow-black/30">
          <div className="p-8">
            ...
            <form action={enrollInCourse.bind(null, courseId)} className="mt-7">
              <Button
                type="submit"
                className="h-14 w-full rounded-2xl bg-lime text-[15px] font-bold text-night transition-all hover:bg-lime/90 active:scale-[0.99]"
              >
                {priceIsFree
            ...
            {totalLessons > 0 && (
              <p className="mt-3 text-center text-[11.5px] font-medium text-chalk-muted">
            ...
            <ul className="mt-8 space-y-3 border-t border-white/[0.08] pt-6">
              {list.map((g, i) => (
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="text-[13.5px] font-medium leading-relaxed text-chalk">{g}</span>
                </li>
              ))}
            </ul>
          </div>
