...
export default function CheckoutLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="landing-theme grain-overlay relative flex min-h-screen flex-col overflow-hidden bg-paper text-ink">
      ...
      <header className="sticky top-0 z-40 border-b border-line bg-paper/75 backdrop-blur-xl">
        <div className="mx-auto flex h-16 w-full max-w-[1200px] items-center justify-between px-5 md:px-8">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-[16px] font-bold tracking-[-0.02em] text-ink">TESKEL</span>
            <span className="ml-2 rounded-full border border-line px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-ink-muted">Checkout</span>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-8 text-[12px] font-bold uppercase tracking-wider text-ink-muted">
            ...
            <div className="flex items-center gap-2 opacity-40">
               <span className="flex h-5 w-5 items-center justify-center rounded-full border border-line-strong text-[10px]">2</span>
               Payment
            </div>
            <div className="flex items-center gap-2 opacity-40">
               <span className="flex h-5 w-5 items-center justify-center rounded-full border border-line-strong text-[10px]">3</span>
               Success
            </div>
          </div>
      ...
      <footer className="relative z-[1] border-t border-line py-10 bg-paper/80">
