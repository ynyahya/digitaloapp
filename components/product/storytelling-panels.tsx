        ...
        {panels.map((p, i) => (
          ...
          >
            <div className={i % 2 === 1 ? "md:order-2" : undefined}>
              <p className="text-[10.5px] font-bold uppercase tracking-[0.14em] text-chalk-dim">
                {p.eyebrow}
              </p>
              <h3 className="mt-2 text-balance text-[19px] font-semibold leading-tight tracking-tight text-chalk md:text-[22px]">
                {p.title}
              </h3>
              <p className="mt-2 text-pretty text-[13.5px] leading-relaxed text-chalk-muted">
                {p.body}
              </p>
            </div>
