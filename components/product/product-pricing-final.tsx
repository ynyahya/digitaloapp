    ...
    <section className="border-t border-line bg-ink text-paper">
      <div className="mx-auto max-w-[1100px] px-5 py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-[640px] text-center">
          ...
          <h2 className="mt-4 text-balance text-[34px] font-extrabold leading-tight tracking-[-0.01em] text-paper md:text-[46px]">
            Get {title} today
          </h2>
        ...
        <div className="mx-auto mt-14 max-w-[520px] overflow-hidden rounded-3xl border border-paper/10 bg-paper text-ink shadow-2xl shadow-black/30">
          <div className="p-8">
            ...
            <Link
              href={checkoutHref}
              className="mt-7 inline-flex h-14 w-full items-center justify-center rounded-2xl bg-ink text-[15px] font-bold text-paper transition-all hover:bg-ink-soft active:scale-[0.99]"
            >
              Buy now — {formatCurrency(priceCents, currency)}
            </Link>

            <p className="mt-3 flex items-center justify-center gap-1.5 text-center text-[11.5px] font-medium text-ink-muted">
